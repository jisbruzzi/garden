---
title: How I imported wordpress.com content into my 11ty blog
excerpt: Scripts and method
---
- Step 1: use wordpress.com [export tool](https://wordpress.com/export) to download an xml that contains all data from the blog. It is emailed to you in an email!
- Step 2: use the following python script to extract posts and pages from your wordpress blog. 
